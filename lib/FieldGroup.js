...
var FieldGroup = function (_Component) {
    ...
    function FieldGroup() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = FieldGroup.__proto__ || Object.getPrototypeOf(FieldGroup)).call.apply(_ref, [this].concat(args))), _this), _this.refCallback = function (input) {
            _this.$input = input;
        ...
        }, _this.onEvent = function (ev) {
            return _this.props.$trigger(ev);
        ...
        value: function render() {
            ...
            var children = _react.Children.map(this.props.children, function (elem, index) {
                return (0, _react.cloneElement)(elem, Object.assign({
                    ...
                    onChange: _this2.onEvent,
                    onFocus: _this2.onEvent,
                    onBlur: _this2.onEvent
