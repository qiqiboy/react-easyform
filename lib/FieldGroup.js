...
var _jsxFileName = 'src/FieldGroup.jsx';
...
var FieldGroup = function (_Component) {
    ...
    function FieldGroup() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = FieldGroup.__proto__ || Object.getPrototypeOf(FieldGroup)).call.apply(_ref, [this].concat(args))), _this), _this.onChange = function (e) {
            var checkedInputs = [].slice.call(_this.refs.input.querySelectorAll('[name=' + _this.props.name + ']')).filter(function (input) {
    ...
    _createClass(FieldGroup, [{
        ...
        value: function render() {
            ...
            var myProps = _omit2.default.apply(undefined, [this.props, 'onChange'].concat(_toConsumableArray(_filterProps2.default)));
