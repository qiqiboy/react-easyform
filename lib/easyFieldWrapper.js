    ...
    return _temp2 = _class = function (_Component) {
        ...
        function FieldWrapper() {
            ...
            return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = FieldWrapper.__proto__ || Object.getPrototypeOf(FieldWrapper)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
                ...
                //$viewValue: '',
                //$modelValue: ''
            }, _this.parseValue = parser || function ($input) {
                var elem = _this.getElem($input);

                var type = elem.type;
                return elem.nodeName.toUpperCase() == 'INPUT' && (type == 'radio' || type == 'checkbox') && !elem.checked ? null : elem.value;
            }, _this.initField = function ($input) {
                var elem = _this.getElem($input);
                _this.$input = $input;
                ...
                var value = _this.parseValue(_this.$input);
                ...
                var _this$props2 = _this.props,
                    ...
                    __onFocus__ = _this$props2.__onFocus__;
                ...
                var _this$props3 = _this.props,
                    ...
                    __onBlur__ = _this$props3.__onBlur__;
        ...
        _createClass(FieldWrapper, [{
                ...
                if ($pending && !$invalid) {
                    try {
                        props.asyncValidator(value).then(function () {
                            ...
                            //确保返回结果对应的是当前输入
                            if (_this2.parseValue(_this2.$input) == value) {
            ...
            value: function render() {
                return _react2.default.createElement(WrappedComponent, Object.assign({}, this.props, this.context, { easyfield: this.state || {}, onChange: this.onChange, onFocus: this.onFocus, onBlur: this.onBlur, __init__: this.initField, __destroy__: this.destroy }));
            }
        }]);
