...
exports.default = function (WrappedComponent) {
    ...
    return _temp2 = _class = function (_Component) {
        ...
        function FieldWrapper() {
            ...
            }, _this.handleEvent = function (type, _ev) {
                var ev = {
                    type: type,
                    target: _ev ? _ev.target : _this.$input
                };
                ...
                (function () {
                    switch (type) {
                        ...
                        case 'blur':
                            ...
                            var handler = _this.props[type == 'focus' ? 'onFocus' : 'onBlur'];
                            if (_this.props['data-groupField']) {
                                handler && handler(ev);
                            } else {
                                _this.handleState({
            ...
            value: function getNewState(value) {
                ...
                (0, _each2.default)(this.validatorHandlers, function (checker, type) {
                    ...
                    if ((name === 'required' || !$error.required) && props[type] && checker(value, propValue) === false) {
                        $error[type] = validMessage[type] || _this2.context.$$config.defaultErrorMsg;
                        $invalid = true;
                    }
                });
        ...
        $$getControl: _react.PropTypes.func
    }, _temp2;
};
